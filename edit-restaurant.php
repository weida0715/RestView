...
<section class="form-page-shell">
    ...
    <?php if ($restaurant): ?>
        <form action="edit-restaurant.php" method="POST">
            ...
            <input type="text" id="cuisine_type" name="cuisine_type" value="<?= htmlspecialchars($restaurant['cuisine_type']) ?>" required>

            <label for="location">Location:</label>
            <input type="text" id="location" name="location" value="<?= htmlspecialchars($restaurant['location']) ?>" required>

            <label for="opening_hours">Opening Hours:</label>
            <input type="text" id="opening_hours" name="opening_hours" value="<?= htmlspecialchars($restaurant['opening_hours']) ?>" required>
